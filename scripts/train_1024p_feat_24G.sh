...
python train.py --name label2city_1024p_feat --netG cas_resnet --ngf 32 --num_D 3 --pool_size 1 --load_pretrain checkpoints/label2city_512p_feat/ --niter_fix_global 10 --resize_or_crop none --use_instance --instance_feat --load_features